...
export const HOST_PACKAGE_NAME = "host";
...
export interface HostMapGrpcServiceController {
  ...
  readMapFile(
    request: ReadMapRequest,
    metadata?: Metadata,
  ): Promise<ReadMapResponse> | Observable<ReadMapResponse> | ReadMapResponse;
}

export function HostMapGrpcServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["readMapList", "readMapFile"];
    for (const method of grpcMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcMethod("HostMapGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
    const grpcStreamMethods: string[] = [];
    for (const method of grpcStreamMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcStreamMethod("HostMapGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
  };
}

export const HOST_MAP_GRPC_SERVICE_NAME = "HostMapGrpcService";
...
export interface HostFileGrpcServiceController {
  readFileList(
    request: ReadFileListRequest,
    metadata?: Metadata,
  ): Promise<ReadFileListResponse> | Observable<ReadFileListResponse> | ReadFileListResponse;

  readFile(
    request: ReadFileRequest,
    metadata?: Metadata,
  ): Promise<ReadFileResponse> | Observable<ReadFileResponse> | ReadFileResponse;
  ...
  updateFile(
    ...
    metadata?: Metadata,
  ): Promise<UpdateFileResponse> | Observable<UpdateFileResponse> | UpdateFileResponse;
  ...
  downloadFile(
    ...
    metadata?: Metadata,
  ): Promise<DownloadFileResponse> | Observable<DownloadFileResponse> | DownloadFileResponse;
}

export function HostFileGrpcServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcMethod("HostFileGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
    const grpcStreamMethods: string[] = [];
    for (const method of grpcStreamMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcStreamMethod("HostFileGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
  };
}

export const HOST_FILE_GRPC_SERVICE_NAME = "HostFileGrpcService";
...
export function HostUpdateGrpcServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = [
      "testPing",
      "getNewVersion",
    ...
    for (const method of grpcMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcMethod("HostUpdateGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
    const grpcStreamMethods: string[] = [];
    for (const method of grpcStreamMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcStreamMethod("HostUpdateGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
  };
}

export const HOST_UPDATE_GRPC_SERVICE_NAME = "HostUpdateGrpcService";
