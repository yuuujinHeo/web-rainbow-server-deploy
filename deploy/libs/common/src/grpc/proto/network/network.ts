...
export const NETWORK_PACKAGE_NAME = "network";
...
export interface NetworkGrpcServiceController {
  getNetwork(
    request: Empty,
    metadata?: Metadata,
  ): Promise<GetNetworkResponse> | Observable<GetNetworkResponse> | GetNetworkResponse;
  ...
  getEthernet(
    request: Empty,
    metadata?: Metadata,
  ): Promise<GetEthernetResponse> | Observable<GetEthernetResponse> | GetEthernetResponse;
  ...
  setNetwork(
    ...
    metadata?: Metadata,
  ): Promise<SetNetworkResponse> | Observable<SetNetworkResponse> | SetNetworkResponse;

  connectWifi(
    request: ConnectWifiRequest,
    metadata?: Metadata,
  ): Promise<ConnectWifiResponse> | Observable<ConnectWifiResponse> | ConnectWifiResponse;

  getWifiList(
    request: Empty,
    metadata?: Metadata,
  ): Promise<WifiListResponse> | Observable<WifiListResponse> | WifiListResponse;
...
export function NetworkGrpcServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcMethods) {
      ...
      GrpcMethod("NetworkGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
    const grpcStreamMethods: string[] = [];
    for (const method of grpcStreamMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcStreamMethod("NetworkGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
  };
}

export const NETWORK_GRPC_SERVICE_NAME = "NetworkGrpcService";
