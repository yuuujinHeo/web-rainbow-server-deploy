...
var openapi_schema_parser_1 = __importDefault(require("@asyncapi/openapi-schema-parser"));
var avro_schema_parser_1 = __importDefault(require("@asyncapi/avro-schema-parser"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, (0, parser_1.parse)(content, parserOptions)];
                    case 1:
                        asyncapi = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, (0, parser_1.parseFromUrl)(arg.url, arg.requestOptions, parserOptions)];
                    case 1:
                        asyncapi = _a.sent();
                        return [2, { asyncapi: asyncapi }];
                    case 2:
