...
export const protobufPackage = "amr";
...
export const AMR_PACKAGE_NAME = "amr";
...
export interface AmrGrpcServiceController {
  readAmrList(
    request: ReadAmrListRequest,
    metadata?: Metadata,
  ): Promise<ReadAmrListResponse> | Observable<ReadAmrListResponse> | ReadAmrListResponse;
  ...
  createAmr(
    ...
    metadata?: Metadata,
  ): Promise<CreateAmrResponse> | Observable<CreateAmrResponse> | CreateAmrResponse;

  updateAmr(
    request: UpdateAmrRequest,
    metadata?: Metadata,
  ): Promise<UpdateAmrResponse> | Observable<UpdateAmrResponse> | UpdateAmrResponse;

  deleteAmr(
    request: DeleteAmrRequest,
    metadata?: Metadata,
  ): Promise<DeleteAmrResponse> | Observable<DeleteAmrResponse> | DeleteAmrResponse;
}
...
export function AmrGrpcServiceControllerMethods() {
  return function (constructor: Function) {
    ...
    for (const method of grpcStreamMethods) {
      const descriptor: any = Reflect.getOwnPropertyDescriptor(constructor.prototype, method);
      GrpcStreamMethod("AmrGrpcService", method)(constructor.prototype[method], method, descriptor);
    }
  };
}

export const AMR_GRPC_SERVICE_NAME = "AmrGrpcService";
